...
OFILES = gba.o font.o game.o images/gameBoard.o \
images/unselectedCard.o images/selectedCard.o images/openedCard1.o \
images/openedCard2.o images/dragonFace.o images/electrFace.o images/fireFace.o \
images/flyingFace.o images/ghostFace.o images/grassFace.o images/normalFace.o \
images/psychcFace.o images/waterFace.o images/matchedCard.o images/titleScreen.o
